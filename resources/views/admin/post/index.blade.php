...
<div>
         ...
         <li><a href='/post-details'><i class="fas fa-list-ul" aria-hidden="true"></i>Post Details</a></li>&nbsp;
  ...
  {{Form::open(['url'=>'/post','method'=>'post','files'=>true])}}
    ...
    <div class="form-group">
     ...
     <div class="form-group">
      ...
      <div class="col-sm-10">          
        {{Form::text('post_title','',['class'=>'form-control','placeholder'=>'Enter Post Title','title'=>'post_title'])}}
        <br/>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
       {{Form::textarea('post_description','',['class'=>'form-control','placeholder'=>'Enter Post Description','title'=>'post_description','cols'=>'40','rows'=>'5'])}}
      </br>
