...
<div>
 ...
 <div class="container">
  {{Form::open(['url'=>"/advertise/$edit_data->advertise_id",'method'=>'put','files'=>true])}}
    <div class="form-group">
    	{{Form::label('advertise_title','Advertise Title',['class'=>'control-label col-sm-2'])}}
      <div class="col-sm-10">
      {{Form::text('advertise_title',$edit_data->advertise_title,['class'=>'form-control'])}} 
      	<br/>
     ...
     <div class="form-group">
      ...
      <div class="col-sm-10">       
        @if(!empty($edit_data->avdertise_description))
        {{Form::checkbox('advertise_type','',null,['class'=>'content','checked'=>'checked'])}}
        @else
        {{Form::checkbox('advertise_type','',null,['class'=>'content'])}}
        @endif
        {{Form::label('content','Content')}}   
        @if(!empty($edit_data->advertise_image))
        {{Form::checkbox('advertise_type','',null,['class'=>'image','checked'=>'checked'])}}
        @else
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">  
       ...
       {{Form::textarea('avdertise_description',$edit_data->avdertise_description,['class'=>'form-control description','placeholder'=>'Enter Post Description','title'=>'avdertise_description','cols'=>'40','rows'=>'5'])}}
      </br>
  ...
  <div class="form-group">
    {{Form::label('','')}}
   <div class="col-sm-10">
     <img id='blah' style="height:180px;" src="{{asset($edit_data->advertise_image)}}"  onerror="this.src='{{asset('img/blankavatar.png')}}'"      alt="your image" class='img-responsive img-circle' />
