	...
	<div class="met_carousel_wrap">
		<div class="met_carousel clearfix">
		          <div class="met_carousel_column"><div class="n_cat_list_image" style="height: 200px;">
						...
						@if($details_value->sub_catagory_name=='-No Data Found-')
						@else
						<a href="" style="font-size: 21px;font-weight: 500;" class="n_link n_color vg-category-carousel"><b>{{$details_value->sub_catagory_name}}</b></a>
						@endif
